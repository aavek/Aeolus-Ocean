...
An all-weather marine simulator that can be implemented as a digital twin for the autonomous navigation of surface vessels as they interact with wind generated waves, as they attempt to reach waypoints while avoiding collisions with other vessels, obstacles and land.
...
Once you download the [release](https://github.com/aavek/Aeolus-Ocean/releases/tag/v1.0), you can run the program with ```AEOLUS OCEAN.exe```.
